...
public class IntegrationsHandlerTest extends TestCase {
    ...
    public void test_createIntegration() throws NovuNetworkException, IOException, InterruptedException {
        ...
        assertEquals("/integrations/create-integrations/IntegrationRequest(providerId=pId,%20channel=PUSH,%20credentials=null,%20active=true,%20check=null)", request.getPath());
    ...
    public void test_updateIntegration() throws NovuNetworkException, IOException, InterruptedException {
        ...
        assertEquals("/integrations/Test/IntegrationRequest(providerId=pId,%20channel=PUSH,%20credentials=null,%20active=true,%20check=null)", request.getPath());
