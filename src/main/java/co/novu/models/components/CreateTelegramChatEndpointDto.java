...
public class CreateTelegramChatEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateTelegramChatEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateTelegramChatEndpointDtoType type;

    /**
     * Telegram chat endpoint data
     */
    @JsonProperty("endpoint")
    private TelegramChatEndpointDto endpoint;

    @JsonCreator
    public CreateTelegramChatEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateTelegramChatEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateTelegramChatEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull TelegramChatEndpointDto endpoint) {
    ...
    public CreateTelegramChatEndpointDto(
            ...
            @Nonnull CreateTelegramChatEndpointDtoType type,
            @Nonnull TelegramChatEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateTelegramChatEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateTelegramChatEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateTelegramChatEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateTelegramChatEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateTelegramChatEndpointDto withContext(@Nullable Map<String, CreateTelegramChatEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateTelegramChatEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateTelegramChatEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateTelegramChatEndpointDto withType(@Nonnull CreateTelegramChatEndpointDtoType type) {
     ...
     * Telegram chat endpoint data
     */
    public CreateTelegramChatEndpointDto withEndpoint(@Nonnull TelegramChatEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateTelegramChatEndpointDto other = (CreateTelegramChatEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateTelegramChatEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateTelegramChatEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateTelegramChatEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * Telegram chat endpoint data
         */
        public Builder endpoint(@Nonnull TelegramChatEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateTelegramChatEndpointDto build() {
            return new CreateTelegramChatEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
