...
public class EmailStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the email step
     */
    @JsonProperty("controls")
    private EmailControlsMetadataResponseDto controls;
    ...
    private EmailStepResponseDtoControlValues controlValues;
    ...
    public EmailStepResponseDto(
            @JsonProperty("controls") @Nonnull EmailControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable EmailStepResponseDtoControlValues controlValues,
    ...
    public EmailStepResponseDto(
            @Nonnull EmailControlsMetadataResponseDto controls,
     ...
     * Control values for the email step
     */
    public Optional<EmailStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the email step
     */
    public EmailStepResponseDto withControls(@Nonnull EmailControlsMetadataResponseDto controls) {
     ...
     * Control values for the email step
     */
    public EmailStepResponseDto withControlValues(@Nullable EmailStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public EmailStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public EmailStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public EmailStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public EmailStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public EmailStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public EmailStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public EmailStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public EmailStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public EmailStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public EmailStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public EmailStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public EmailStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        EmailStepResponseDto other = (EmailStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(EmailStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the email step
         */
        public Builder controls(@Nonnull EmailControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the email step
         */
        public Builder controlValues(@Nullable EmailStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public EmailStepResponseDto build() {
            return new EmailStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
