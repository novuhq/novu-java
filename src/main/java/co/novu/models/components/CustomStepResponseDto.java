...
public class CustomStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the custom step
     */
    @JsonProperty("controls")
    private CustomControlsMetadataResponseDto controls;
    ...
    private CustomStepResponseDtoControlValues controlValues;
    ...
    public CustomStepResponseDto(
            @JsonProperty("controls") @Nonnull CustomControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable CustomStepResponseDtoControlValues controlValues,
    ...
    public CustomStepResponseDto(
            @Nonnull CustomControlsMetadataResponseDto controls,
     ...
     * Control values for the custom step
     */
    public Optional<CustomStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the custom step
     */
    public CustomStepResponseDto withControls(@Nonnull CustomControlsMetadataResponseDto controls) {
     ...
     * Control values for the custom step
     */
    public CustomStepResponseDto withControlValues(@Nullable CustomStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public CustomStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public CustomStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public CustomStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public CustomStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public CustomStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public CustomStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public CustomStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public CustomStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public CustomStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public CustomStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public CustomStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public CustomStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CustomStepResponseDto other = (CustomStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CustomStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the custom step
         */
        public Builder controls(@Nonnull CustomControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the custom step
         */
        public Builder controlValues(@Nullable CustomStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public CustomStepResponseDto build() {
            return new CustomStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
