...
@JsonDeserialize(using = MessageId._Deserializer.class)
public class MessageId {

    @JsonValue
    private final TypedObject value;
    
    private MessageId(TypedObject value) {
        this.value = value;
    }

    public static MessageId of(String value) {
        Utils.checkNotNull(value, "value");
        return new MessageId(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }

    public static MessageId of(List<String> value) {
        Utils.checkNotNull(value, "value");
        return new MessageId(TypedObject.of(value, JsonShape.DEFAULT, new TypeReference<>(){}));
    }
   ...
   public Optional<JsonNode> asJson() {
    ...
    public static final class _Deserializer extends OneOfDeserializer<MessageId> {

        public _Deserializer() {
            super(MessageId.class, false,
    ...
    public String toString() {
        return Utils.toString(MessageId.class,
                "value", value);
    }
