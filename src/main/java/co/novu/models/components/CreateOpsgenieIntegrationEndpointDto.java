...
public class CreateOpsgenieIntegrationEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateOpsgenieIntegrationEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateOpsgenieIntegrationEndpointDtoType type;

    /**
     * Opsgenie integration endpoint data. `apiKey` is encrypted at rest on the channel endpoint
     * (`endpoint` field); `region` remains plaintext. No linked channel connection.
     */
    @JsonProperty("endpoint")
    private OpsgenieIntegrationEndpointDto endpoint;

    @JsonCreator
    public CreateOpsgenieIntegrationEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateOpsgenieIntegrationEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateOpsgenieIntegrationEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull OpsgenieIntegrationEndpointDto endpoint) {
    ...
    public CreateOpsgenieIntegrationEndpointDto(
            ...
            @Nonnull CreateOpsgenieIntegrationEndpointDtoType type,
            @Nonnull OpsgenieIntegrationEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateOpsgenieIntegrationEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateOpsgenieIntegrationEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateOpsgenieIntegrationEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateOpsgenieIntegrationEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateOpsgenieIntegrationEndpointDto withContext(@Nullable Map<String, CreateOpsgenieIntegrationEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateOpsgenieIntegrationEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateOpsgenieIntegrationEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateOpsgenieIntegrationEndpointDto withType(@Nonnull CreateOpsgenieIntegrationEndpointDtoType type) {
     ...
     * (`endpoint` field); `region` remains plaintext. No linked channel connection.
     */
    public CreateOpsgenieIntegrationEndpointDto withEndpoint(@Nonnull OpsgenieIntegrationEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateOpsgenieIntegrationEndpointDto other = (CreateOpsgenieIntegrationEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateOpsgenieIntegrationEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateOpsgenieIntegrationEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateOpsgenieIntegrationEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * (`endpoint` field); `region` remains plaintext. No linked channel connection.
         */
        public Builder endpoint(@Nonnull OpsgenieIntegrationEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateOpsgenieIntegrationEndpointDto build() {
            return new CreateOpsgenieIntegrationEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
