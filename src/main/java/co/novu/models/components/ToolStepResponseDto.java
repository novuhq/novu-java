...
public class ToolStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the tool step
     */
    @JsonProperty("controls")
    private ToolControlsMetadataResponseDto controls;
    ...
    private ToolStepResponseDtoControlValues controlValues;
    ...
    @JsonCreator
    public ToolStepResponseDto(
            @JsonProperty("controls") @Nonnull ToolControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable ToolStepResponseDtoControlValues controlValues,
    ...
    public ToolStepResponseDto(
            @Nonnull ToolControlsMetadataResponseDto controls,
     ...
     * Control values for the tool step
     */
    public Optional<ToolStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the tool step
     */
    public ToolStepResponseDto withControls(@Nonnull ToolControlsMetadataResponseDto controls) {
     ...
     * Control values for the tool step
     */
    public ToolStepResponseDto withControlValues(@Nullable ToolStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public ToolStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public ToolStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public ToolStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public ToolStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public ToolStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public ToolStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public ToolStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public ToolStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public ToolStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public ToolStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public ToolStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public ToolStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ToolStepResponseDto other = (ToolStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ToolStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the tool step
         */
        public Builder controls(@Nonnull ToolControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the tool step
         */
        public Builder controlValues(@Nullable ToolStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public ToolStepResponseDto build() {
            return new ToolStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
