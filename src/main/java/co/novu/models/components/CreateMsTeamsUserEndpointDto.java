...
public class CreateMsTeamsUserEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateMsTeamsUserEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateMsTeamsUserEndpointDtoType type;

    /**
     * MS Teams user endpoint data
     */
    @JsonProperty("endpoint")
    private MsTeamsUserEndpointDto endpoint;
    ...
    public CreateMsTeamsUserEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateMsTeamsUserEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateMsTeamsUserEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull MsTeamsUserEndpointDto endpoint) {
    ...
    public CreateMsTeamsUserEndpointDto(
            ...
            @Nonnull CreateMsTeamsUserEndpointDtoType type,
            @Nonnull MsTeamsUserEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateMsTeamsUserEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateMsTeamsUserEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateMsTeamsUserEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateMsTeamsUserEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateMsTeamsUserEndpointDto withContext(@Nullable Map<String, CreateMsTeamsUserEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateMsTeamsUserEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateMsTeamsUserEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateMsTeamsUserEndpointDto withType(@Nonnull CreateMsTeamsUserEndpointDtoType type) {
     ...
     * MS Teams user endpoint data
     */
    public CreateMsTeamsUserEndpointDto withEndpoint(@Nonnull MsTeamsUserEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateMsTeamsUserEndpointDto other = (CreateMsTeamsUserEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateMsTeamsUserEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateMsTeamsUserEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateMsTeamsUserEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * MS Teams user endpoint data
         */
        public Builder endpoint(@Nonnull MsTeamsUserEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateMsTeamsUserEndpointDto build() {
            return new CreateMsTeamsUserEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
