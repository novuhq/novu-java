...
public class CreatePhoneEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreatePhoneEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreatePhoneEndpointDtoType type;

    /**
     * Phone endpoint data
     */
    @JsonProperty("endpoint")
    private PhoneEndpointDto endpoint;
    ...
    public CreatePhoneEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreatePhoneEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreatePhoneEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull PhoneEndpointDto endpoint) {
    ...
    public CreatePhoneEndpointDto(
            ...
            @Nonnull CreatePhoneEndpointDtoType type,
            @Nonnull PhoneEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreatePhoneEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreatePhoneEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreatePhoneEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreatePhoneEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreatePhoneEndpointDto withContext(@Nullable Map<String, CreatePhoneEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreatePhoneEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreatePhoneEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreatePhoneEndpointDto withType(@Nonnull CreatePhoneEndpointDtoType type) {
     ...
     * Phone endpoint data
     */
    public CreatePhoneEndpointDto withEndpoint(@Nonnull PhoneEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreatePhoneEndpointDto other = (CreatePhoneEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreatePhoneEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreatePhoneEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreatePhoneEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * Phone endpoint data
         */
        public Builder endpoint(@Nonnull PhoneEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreatePhoneEndpointDto build() {
            return new CreatePhoneEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
