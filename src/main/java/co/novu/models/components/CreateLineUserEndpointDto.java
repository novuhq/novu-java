...
public class CreateLineUserEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateLineUserEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateLineUserEndpointDtoType type;

    /**
     * LINE user endpoint data
     */
    @JsonProperty("endpoint")
    private LineUserEndpointDto endpoint;

    @JsonCreator
    public CreateLineUserEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateLineUserEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateLineUserEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull LineUserEndpointDto endpoint) {
    ...
    public CreateLineUserEndpointDto(
            ...
            @Nonnull CreateLineUserEndpointDtoType type,
            @Nonnull LineUserEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateLineUserEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateLineUserEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateLineUserEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateLineUserEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateLineUserEndpointDto withContext(@Nullable Map<String, CreateLineUserEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateLineUserEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateLineUserEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateLineUserEndpointDto withType(@Nonnull CreateLineUserEndpointDtoType type) {
     ...
     * LINE user endpoint data
     */
    public CreateLineUserEndpointDto withEndpoint(@Nonnull LineUserEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateLineUserEndpointDto other = (CreateLineUserEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateLineUserEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateLineUserEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateLineUserEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * LINE user endpoint data
         */
        public Builder endpoint(@Nonnull LineUserEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateLineUserEndpointDto build() {
            return new CreateLineUserEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
