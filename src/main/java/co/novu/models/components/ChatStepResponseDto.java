...
public class ChatStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the chat step
     */
    @JsonProperty("controls")
    private ChatControlsMetadataResponseDto controls;
    ...
    private ChatStepResponseDtoControlValues controlValues;
    ...
    @JsonCreator
    public ChatStepResponseDto(
            @JsonProperty("controls") @Nonnull ChatControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable ChatStepResponseDtoControlValues controlValues,
    ...
    public ChatStepResponseDto(
            @Nonnull ChatControlsMetadataResponseDto controls,
     ...
     * Control values for the chat step
     */
    public Optional<ChatStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the chat step
     */
    public ChatStepResponseDto withControls(@Nonnull ChatControlsMetadataResponseDto controls) {
     ...
     * Control values for the chat step
     */
    public ChatStepResponseDto withControlValues(@Nullable ChatStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public ChatStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public ChatStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public ChatStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public ChatStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public ChatStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public ChatStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public ChatStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public ChatStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public ChatStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public ChatStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public ChatStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public ChatStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ChatStepResponseDto other = (ChatStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ChatStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the chat step
         */
        public Builder controls(@Nonnull ChatControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the chat step
         */
        public Builder controlValues(@Nullable ChatStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public ChatStepResponseDto build() {
            return new ChatStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
