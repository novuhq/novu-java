...
public class CreateGrafanaOnCallIntegrationEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateGrafanaOnCallIntegrationEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateGrafanaOnCallIntegrationEndpointDtoType type;

    /**
     * Grafana OnCall integration endpoint data. `url` and `authToken` are encrypted at rest on the channel
     * endpoint (`endpoint` field). No linked channel connection.
     */
    @JsonProperty("endpoint")
    private GrafanaOnCallIntegrationEndpointDto endpoint;

    @JsonCreator
    public CreateGrafanaOnCallIntegrationEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateGrafanaOnCallIntegrationEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateGrafanaOnCallIntegrationEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull GrafanaOnCallIntegrationEndpointDto endpoint) {
    ...
    public CreateGrafanaOnCallIntegrationEndpointDto(
            ...
            @Nonnull CreateGrafanaOnCallIntegrationEndpointDtoType type,
            @Nonnull GrafanaOnCallIntegrationEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateGrafanaOnCallIntegrationEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateGrafanaOnCallIntegrationEndpointDto withContext(@Nullable Map<String, CreateGrafanaOnCallIntegrationEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withType(@Nonnull CreateGrafanaOnCallIntegrationEndpointDtoType type) {
     ...
     * endpoint (`endpoint` field). No linked channel connection.
     */
    public CreateGrafanaOnCallIntegrationEndpointDto withEndpoint(@Nonnull GrafanaOnCallIntegrationEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateGrafanaOnCallIntegrationEndpointDto other = (CreateGrafanaOnCallIntegrationEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateGrafanaOnCallIntegrationEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateGrafanaOnCallIntegrationEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateGrafanaOnCallIntegrationEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * endpoint (`endpoint` field). No linked channel connection.
         */
        public Builder endpoint(@Nonnull GrafanaOnCallIntegrationEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateGrafanaOnCallIntegrationEndpointDto build() {
            return new CreateGrafanaOnCallIntegrationEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
