...
public class SmsStepResponseDto implements WorkflowResponseDtoStep {
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public SmsStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public SmsStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
