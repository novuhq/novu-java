...
public class HttpRequestStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the HTTP request step
     */
    @JsonProperty("controls")
    private HttpRequestControlsMetadataResponseDto controls;
    ...
    private HttpRequestStepResponseDtoControlValues controlValues;
    ...
    @JsonCreator
    public HttpRequestStepResponseDto(
            @JsonProperty("controls") @Nonnull HttpRequestControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable HttpRequestStepResponseDtoControlValues controlValues,
    ...
    public HttpRequestStepResponseDto(
            @Nonnull HttpRequestControlsMetadataResponseDto controls,
     ...
     * Control values for the HTTP request step
     */
    public Optional<HttpRequestStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the HTTP request step
     */
    public HttpRequestStepResponseDto withControls(@Nonnull HttpRequestControlsMetadataResponseDto controls) {
     ...
     * Control values for the HTTP request step
     */
    public HttpRequestStepResponseDto withControlValues(@Nullable HttpRequestStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public HttpRequestStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public HttpRequestStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public HttpRequestStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public HttpRequestStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public HttpRequestStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public HttpRequestStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public HttpRequestStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public HttpRequestStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public HttpRequestStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public HttpRequestStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public HttpRequestStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public HttpRequestStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        HttpRequestStepResponseDto other = (HttpRequestStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(HttpRequestStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the HTTP request step
         */
        public Builder controls(@Nonnull HttpRequestControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the HTTP request step
         */
        public Builder controlValues(@Nullable HttpRequestStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public HttpRequestStepResponseDto build() {
            return new HttpRequestStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
