...
public class SubscriptionsDeleteErrorDto {
    /**
     ...
     * The subscriber ID that failed
     */
    public SubscriptionsDeleteErrorDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * The error code
     */
    public SubscriptionsDeleteErrorDto withCode(@Nonnull String code) {
     ...
     * The error message
     */
    public SubscriptionsDeleteErrorDto withMessage(@Nonnull String message) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubscriptionsDeleteErrorDto other = (SubscriptionsDeleteErrorDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SubscriptionsDeleteErrorDto.class,
    ...
    public final static class Builder {
        ...
        public SubscriptionsDeleteErrorDto build() {
            return new SubscriptionsDeleteErrorDto(
                subscriberId, code, message);
        }
