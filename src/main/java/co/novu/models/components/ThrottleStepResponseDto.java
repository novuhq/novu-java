...
public class ThrottleStepResponseDto implements WorkflowResponseDtoStep {
    ...
    public ThrottleStepResponseDto(
            @Nonnull ThrottleControlsMetadataResponseDto controls,
     ...
     * Controls metadata for the throttle step
     */
    public ThrottleStepResponseDto withControls(@Nonnull ThrottleControlsMetadataResponseDto controls) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public ThrottleStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public ThrottleStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public ThrottleStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public ThrottleStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public ThrottleStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public ThrottleStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public ThrottleStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public ThrottleStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public ThrottleStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public ThrottleStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public ThrottleStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ThrottleStepResponseDto other = (ThrottleStepResponseDto) o;
        return 
    ...
    public final static class Builder {
         ...
         * Controls metadata for the throttle step
         */
        public Builder controls(@Nonnull ThrottleControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
