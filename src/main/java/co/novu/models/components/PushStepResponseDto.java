...
public class PushStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the push step
     */
    @JsonProperty("controls")
    private PushControlsMetadataResponseDto controls;
    ...
    private PushStepResponseDtoControlValues controlValues;
    ...
    @JsonCreator
    public PushStepResponseDto(
            @JsonProperty("controls") @Nonnull PushControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable PushStepResponseDtoControlValues controlValues,
    ...
    public PushStepResponseDto(
            @Nonnull PushControlsMetadataResponseDto controls,
     ...
     * Control values for the push step
     */
    public Optional<PushStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the push step
     */
    public PushStepResponseDto withControls(@Nonnull PushControlsMetadataResponseDto controls) {
     ...
     * Control values for the push step
     */
    public PushStepResponseDto withControlValues(@Nullable PushStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public PushStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public PushStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public PushStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public PushStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public PushStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public PushStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public PushStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public PushStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public PushStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public PushStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public PushStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public PushStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PushStepResponseDto other = (PushStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(PushStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the push step
         */
        public Builder controls(@Nonnull PushControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the push step
         */
        public Builder controlValues(@Nullable PushStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public PushStepResponseDto build() {
            return new PushStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
