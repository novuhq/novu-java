...
public class CreateWebexRoomEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateWebexRoomEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateWebexRoomEndpointDtoType type;

    /**
     * Webex room endpoint data
     */
    @JsonProperty("endpoint")
    private WebexRoomEndpointDto endpoint;

    @JsonCreator
    public CreateWebexRoomEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateWebexRoomEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateWebexRoomEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull WebexRoomEndpointDto endpoint) {
    ...
    public CreateWebexRoomEndpointDto(
            ...
            @Nonnull CreateWebexRoomEndpointDtoType type,
            @Nonnull WebexRoomEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateWebexRoomEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateWebexRoomEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateWebexRoomEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateWebexRoomEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateWebexRoomEndpointDto withContext(@Nullable Map<String, CreateWebexRoomEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateWebexRoomEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this Webex endpoint.
     */
    public CreateWebexRoomEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateWebexRoomEndpointDto withType(@Nonnull CreateWebexRoomEndpointDtoType type) {
     ...
     * Webex room endpoint data
     */
    public CreateWebexRoomEndpointDto withEndpoint(@Nonnull WebexRoomEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateWebexRoomEndpointDto other = (CreateWebexRoomEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateWebexRoomEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateWebexRoomEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateWebexRoomEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * Webex room endpoint data
         */
        public Builder endpoint(@Nonnull WebexRoomEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateWebexRoomEndpointDto build() {
            return new CreateWebexRoomEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
