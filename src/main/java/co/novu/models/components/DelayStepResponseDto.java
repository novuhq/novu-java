...
public class DelayStepResponseDto implements WorkflowResponseDtoStep {
    /**
     * Controls metadata for the delay step
     */
    @JsonProperty("controls")
    private DelayControlsMetadataResponseDto controls;
    ...
    private DelayStepResponseDtoControlValues controlValues;
    ...
    @JsonCreator
    public DelayStepResponseDto(
            @JsonProperty("controls") @Nonnull DelayControlsMetadataResponseDto controls,
            @JsonProperty("controlValues") @Nullable DelayStepResponseDtoControlValues controlValues,
    ...
    public DelayStepResponseDto(
            @Nonnull DelayControlsMetadataResponseDto controls,
     ...
     * Control values for the delay step
     */
    public Optional<DelayStepResponseDtoControlValues> controlValues() {
     ...
     * Controls metadata for the delay step
     */
    public DelayStepResponseDto withControls(@Nonnull DelayControlsMetadataResponseDto controls) {
     ...
     * Control values for the delay step
     */
    public DelayStepResponseDto withControlValues(@Nullable DelayStepResponseDtoControlValues controlValues) {
        this.controlValues = controlValues;
        return this;
    }
     ...
     * <p>`slack`, `whatsapp-business`, `pagerduty`).
     */
    public DelayStepResponseDto withProviderOverrides(@Nullable Map<String, Map<String, Object>> providerOverrides) {
     ...
     * JSON Schema for variables, follows the JSON Schema standard
     */
    public DelayStepResponseDto withVariables(@Nonnull Map<String, Object> variables) {
     ...
     * Unique identifier of the step
     */
    public DelayStepResponseDto withStepId(@Nonnull String stepId) {
     ...
     * Database identifier of the step
     */
    public DelayStepResponseDto withId(@Nonnull String id) {
     ...
     * Name of the step
     */
    public DelayStepResponseDto withName(@Nonnull String name) {
     ...
     * Slug of the step
     */
    public DelayStepResponseDto withSlug(@Nonnull String slug) {
     ...
     * Type of the step
     */
    public DelayStepResponseDto withType(@Nonnull StepTypeEnum type) {
     ...
     * Origin of the layout
     */
    public DelayStepResponseDto withOrigin(@Nonnull ResourceOriginEnum origin) {
     ...
     * Workflow identifier
     */
    public DelayStepResponseDto withWorkflowId(@Nonnull String workflowId) {
     ...
     * Workflow database identifier
     */
    public DelayStepResponseDto withWorkflowDatabaseId(@Nonnull String workflowDatabaseId) {
     ...
     * Issues associated with the step
     */
    public DelayStepResponseDto withIssues(@Nullable StepIssuesDto issues) {
        this.issues = issues;
        return this;
    }
     ...
     * Hash identifying the deployed Cloudflare Worker for this step
     */
    public DelayStepResponseDto withStepResolverHash(@Nullable String stepResolverHash) {
        this.stepResolverHash = stepResolverHash;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DelayStepResponseDto other = (DelayStepResponseDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DelayStepResponseDto.class,
                "controls", controls,
    ...
    public final static class Builder {
         ...
         * Controls metadata for the delay step
         */
        public Builder controls(@Nonnull DelayControlsMetadataResponseDto controls) {
            this.controls = Utils.checkNotNull(controls, "controls");
            return this;
        }
         ...
         * Control values for the delay step
         */
        public Builder controlValues(@Nullable DelayStepResponseDtoControlValues controlValues) {
            this.controlValues = controlValues;
            return this;
        }
        ...
        public DelayStepResponseDto build() {
            return new DelayStepResponseDto(
                controls, controlValues, providerOverrides,
                variables, stepId, id,
                name, slug, type,
                origin, workflowId, workflowDatabaseId,
