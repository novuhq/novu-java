...
public class CreateToolWebhookEndpointDto implements ChannelEndpointsControllerCreateChannelEndpointRequestBody {
    /**
    ...
    private Map<String, CreateToolWebhookEndpointDtoContextUnion> context;
     ...
     */
    @JsonProperty("type")
    private CreateToolWebhookEndpointDtoType type;

    /**
     * Tool webhook endpoint data. `url` and header values are encrypted at rest on the channel endpoint
     * (`endpoint` field); `method` remains plaintext. No linked channel connection.
     */
    @JsonProperty("endpoint")
    private ToolWebhookEndpointDto endpoint;

    @JsonCreator
    public CreateToolWebhookEndpointDto(
            ...
            @JsonProperty("context") @Nullable Map<String, CreateToolWebhookEndpointDtoContextUnion> context,
            ...
            @JsonProperty("type") @Nonnull CreateToolWebhookEndpointDtoType type,
            @JsonProperty("endpoint") @Nonnull ToolWebhookEndpointDto endpoint) {
    ...
    public CreateToolWebhookEndpointDto(
            ...
            @Nonnull CreateToolWebhookEndpointDtoType type,
            @Nonnull ToolWebhookEndpointDto endpoint) {
    ...
    public Optional<Map<String, CreateToolWebhookEndpointDtoContextUnion>> context() {
     ...
     * automatically.
     */
    public CreateToolWebhookEndpointDto withIdentifier(@Nullable String identifier) {
        this.identifier = identifier;
        return this;
    }
     ...
     * The subscriber ID to which the channel endpoint is linked
     */
    public CreateToolWebhookEndpointDto withSubscriberId(@Nonnull String subscriberId) {
     ...
     * modified). When false or omitted, an unknown subscriberId returns 404.
     */
    public CreateToolWebhookEndpointDto withCreateSubscriberIfMissing(@Nullable Boolean createSubscriberIfMissing) {
        this.createSubscriberIfMissing = createSubscriberIfMissing;
        return this;
    }


    public CreateToolWebhookEndpointDto withContext(@Nullable Map<String, CreateToolWebhookEndpointDtoContextUnion> context) {
        this.context = context;
        return this;
    }
     ...
     * The identifier of the integration to use for this channel endpoint.
     */
    public CreateToolWebhookEndpointDto withIntegrationIdentifier(@Nonnull String integrationIdentifier) {
     ...
     * The identifier of the channel connection to use for this channel endpoint.
     */
    public CreateToolWebhookEndpointDto withConnectionIdentifier(@Nullable String connectionIdentifier) {
        this.connectionIdentifier = connectionIdentifier;
        return this;
    }
     ...
     * Type of channel endpoint
     */
    public CreateToolWebhookEndpointDto withType(@Nonnull CreateToolWebhookEndpointDtoType type) {
     ...
     * (`endpoint` field); `method` remains plaintext. No linked channel connection.
     */
    public CreateToolWebhookEndpointDto withEndpoint(@Nonnull ToolWebhookEndpointDto endpoint) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        CreateToolWebhookEndpointDto other = (CreateToolWebhookEndpointDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(CreateToolWebhookEndpointDto.class,
    ...
    public final static class Builder {
        ...
        public Builder context(@Nullable Map<String, CreateToolWebhookEndpointDtoContextUnion> context) {
            this.context = context;
            return this;
        }
         ...
         * Type of channel endpoint
         */
        public Builder type(@Nonnull CreateToolWebhookEndpointDtoType type) {
            this.type = Utils.checkNotNull(type, "type");
            return this;
        }
         ...
         * (`endpoint` field); `method` remains plaintext. No linked channel connection.
         */
        public Builder endpoint(@Nonnull ToolWebhookEndpointDto endpoint) {
            this.endpoint = Utils.checkNotNull(endpoint, "endpoint");
            return this;
        }

        public CreateToolWebhookEndpointDto build() {
            return new CreateToolWebhookEndpointDto(
                identifier, subscriberId, createSubscriberIfMissing,
                context, integrationIdentifier, connectionIdentifier,
                type, endpoint);
        }
