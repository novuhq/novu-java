...
public class WorkflowInfoDto {
     ...
     * The name of the workflow
     */
    public WorkflowInfoDto withName(@Nonnull String name) {
     ...
     * The unique identifier of the workflow
     */
    public WorkflowInfoDto withWorkflowId(@Nonnull String workflowId) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        WorkflowInfoDto other = (WorkflowInfoDto) o;
        return 
    ...
    public String toString() {
        return Utils.toString(WorkflowInfoDto.class,
                "name", name,
