...
public interface IntegrationsApi {
    ...
    @POST(ENDPOINT + "/create-integrations/{request}")
    public Call<SingleIntegrationResponse> createIntegration(@Path("request") IntegrationRequest request);
    ...
    @PUT(ENDPOINT + "/{integrationId}/{request}")
    public Call<SingleIntegrationResponse> updateIntegration(@Path("integrationId") String integrationId, @Path("request") IntegrationRequest request);
