...
public interface SubscribersApi {
    ...
    Call<SingleSubscriberResponse> updateSubscriber(@Body UpdateSubscriberRequest request,
    ...
    Call<SingleSubscriberResponse> updateSubscriberCredentials(@Body UpdateSubscriberCredentialsRequest request,
                                                               @Path("subscriberId") String subscriberId);

    @DELETE(ENDPOINT + "/{subscriberId}/credentials/{providerId}")
    Call<Void> deleteSubscriberCredentials(@Path("subscriberId") String subscriberId,
                                           @Path("providerId") String providerId);

    @PATCH(ENDPOINT + "/{subscriberId}/online-status")
    Call<SingleSubscriberResponse> updateSubscriberOnlineStatus(@Body UpdateSubscriberOnlineStatusRequest request,
                                                                @Path("subscriberId") String subscriberId);
    ...
    Call<SingleSubscriberPrefResponse> updateSubscriberPreferences(@Body UpdateSubscriberPreferenceRequest request,
                                                                   @Path("subscriberId") String subscriberId,
    ...
    Call<UnseenNotificationsCountResponse> getSubscriberUnseenNotificationsCount(
            @Path("subscriberId") String subscriberId);

    @POST(ENDPOINT + "/{subscriberId}/messages/markAs")
    Call<SubscriberNotificationResponse> markSubscriberMessageFeedAs(@Body MarkSubscriberFeedAsRequest request,
                                                                     @Path("subscriberId") String subscriberId);

    @POST(ENDPOINT + "/{subscriberId}/messages/mark-all")
    Call<Long> markAllSubscriberMessagesFeedAs(@Body MarkAllMessagesRequest request,
                                               @Path("subscriberId") String subscriberId);

    @POST(ENDPOINT + "/{subscriberId}/messages/{messageId}/actions/{type}")
    Call<SubscriberNotificationResponse> markMessageActionAsSeen(@Body MarkMessageActionAsSeenRequest request,
                                                                 @Path("subscriberId") String subscriberId,
