...
public class WorkflowControllerRemoveWorkflow {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "WorkflowController_removeWorkflow",
    ...
    public static class Sync extends Base
            implements RequestOperation<WorkflowControllerRemoveWorkflowRequest, WorkflowControllerRemoveWorkflowResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(WorkflowControllerRemoveWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WorkflowControllerRemoveWorkflowRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(WorkflowControllerRemoveWorkflowRequest request) {
        ...
        @Override
        public WorkflowControllerRemoveWorkflowResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            WorkflowControllerRemoveWorkflowResponse.Builder resBuilder =
            ...
            WorkflowControllerRemoveWorkflowResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<WorkflowControllerRemoveWorkflowRequest, co.novu.models.operations.async.WorkflowControllerRemoveWorkflowResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(WorkflowControllerRemoveWorkflowRequest request) throws Exception {
            HttpRequest req = buildRequest(request, WorkflowControllerRemoveWorkflowRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(WorkflowControllerRemoveWorkflowRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.WorkflowControllerRemoveWorkflowResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.WorkflowControllerRemoveWorkflowResponse.Builder resBuilder =
                    co.novu.models.operations.async.WorkflowControllerRemoveWorkflowResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.WorkflowControllerRemoveWorkflowResponse res = resBuilder.build();
