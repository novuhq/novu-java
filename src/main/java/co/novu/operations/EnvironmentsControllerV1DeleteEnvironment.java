...
public class EnvironmentsControllerV1DeleteEnvironment {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "EnvironmentsControllerV1_deleteEnvironment",
    ...
    public static class Sync extends Base
            implements RequestOperation<EnvironmentsControllerV1DeleteEnvironmentRequest, EnvironmentsControllerV1DeleteEnvironmentResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EnvironmentsControllerV1DeleteEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnvironmentsControllerV1DeleteEnvironmentRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EnvironmentsControllerV1DeleteEnvironmentRequest request) {
        ...
        @Override
        public EnvironmentsControllerV1DeleteEnvironmentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EnvironmentsControllerV1DeleteEnvironmentResponse.Builder resBuilder =
            ...
            EnvironmentsControllerV1DeleteEnvironmentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EnvironmentsControllerV1DeleteEnvironmentRequest, co.novu.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EnvironmentsControllerV1DeleteEnvironmentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EnvironmentsControllerV1DeleteEnvironmentRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EnvironmentsControllerV1DeleteEnvironmentRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse.Builder resBuilder =
                    co.novu.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.EnvironmentsControllerV1DeleteEnvironmentResponse res = resBuilder.build();
