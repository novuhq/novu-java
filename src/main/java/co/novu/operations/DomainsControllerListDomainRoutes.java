...
public class DomainsControllerListDomainRoutes {
    ...
    public static class Sync extends Base
            implements RequestOperation<DomainsControllerListDomainRoutesRequest, DomainsControllerListDomainRoutesResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DomainsControllerListDomainRoutesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerListDomainRoutesRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DomainsControllerListDomainRoutesRequest request) {
        ...
        @Override
        public DomainsControllerListDomainRoutesResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DomainsControllerListDomainRoutesResponse.Builder resBuilder =
            ...
            DomainsControllerListDomainRoutesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListDomainRoutesResponseDto(Utils.unmarshal(response, new TypeReference<ListDomainRoutesResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DomainsControllerListDomainRoutesRequest, co.novu.models.operations.async.DomainsControllerListDomainRoutesResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DomainsControllerListDomainRoutesRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerListDomainRoutesRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DomainsControllerListDomainRoutesRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.DomainsControllerListDomainRoutesResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.DomainsControllerListDomainRoutesResponse.Builder resBuilder =
                    co.novu.models.operations.async.DomainsControllerListDomainRoutesResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.DomainsControllerListDomainRoutesResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDomainRoutesResponseDto>() {})
                            .thenApply(res::withListDomainRoutesResponseDto);
                } else {
