...
public class TranslationControllerDeleteTranslationGroupEndpoint {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "TranslationController_deleteTranslationGroupEndpoint",
    ...
    public static class Sync extends Base
            implements RequestOperation<TranslationControllerDeleteTranslationGroupEndpointRequest, TranslationControllerDeleteTranslationGroupEndpointResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TranslationControllerDeleteTranslationGroupEndpointRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranslationControllerDeleteTranslationGroupEndpointRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranslationControllerDeleteTranslationGroupEndpointRequest request) {
        ...
        @Override
        public TranslationControllerDeleteTranslationGroupEndpointResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranslationControllerDeleteTranslationGroupEndpointResponse.Builder resBuilder =
            ...
            TranslationControllerDeleteTranslationGroupEndpointResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranslationControllerDeleteTranslationGroupEndpointRequest, co.novu.models.operations.async.TranslationControllerDeleteTranslationGroupEndpointResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TranslationControllerDeleteTranslationGroupEndpointRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranslationControllerDeleteTranslationGroupEndpointRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranslationControllerDeleteTranslationGroupEndpointRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.TranslationControllerDeleteTranslationGroupEndpointResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.TranslationControllerDeleteTranslationGroupEndpointResponse.Builder resBuilder =
                    co.novu.models.operations.async.TranslationControllerDeleteTranslationGroupEndpointResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.TranslationControllerDeleteTranslationGroupEndpointResponse res = resBuilder.build();
