...
public class ContextsControllerDeleteContext {
    ...
    public static class Sync extends Base
            implements RequestOperation<ContextsControllerDeleteContextRequest, ContextsControllerDeleteContextResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(ContextsControllerDeleteContextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ContextsControllerDeleteContextRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(ContextsControllerDeleteContextRequest request) {
        ...
        @Override
        public ContextsControllerDeleteContextResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            ContextsControllerDeleteContextResponse.Builder resBuilder =
            ...
            ContextsControllerDeleteContextResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<ContextsControllerDeleteContextRequest, co.novu.models.operations.async.ContextsControllerDeleteContextResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(ContextsControllerDeleteContextRequest request) throws Exception {
            HttpRequest req = buildRequest(request, ContextsControllerDeleteContextRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(ContextsControllerDeleteContextRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.ContextsControllerDeleteContextResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.ContextsControllerDeleteContextResponse.Builder resBuilder =
                    co.novu.models.operations.async.ContextsControllerDeleteContextResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.ContextsControllerDeleteContextResponse res = resBuilder.build();
