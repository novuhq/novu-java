...
public class AgentsControllerCreateAgent {
    ...
    public static class Sync extends Base
            implements RequestOperation<AgentsControllerCreateAgentRequest, AgentsControllerCreateAgentResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AgentsControllerCreateAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AgentsControllerCreateAgentRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AgentsControllerCreateAgentRequest request) {
        ...
        @Override
        public AgentsControllerCreateAgentResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AgentsControllerCreateAgentResponse.Builder resBuilder =
            ...
            AgentsControllerCreateAgentResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AgentsControllerCreateAgentRequest, co.novu.models.operations.async.AgentsControllerCreateAgentResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AgentsControllerCreateAgentRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<AgentsControllerCreateAgentRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AgentsControllerCreateAgentRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.AgentsControllerCreateAgentResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.AgentsControllerCreateAgentResponse.Builder resBuilder =
                    co.novu.models.operations.async.AgentsControllerCreateAgentResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.AgentsControllerCreateAgentResponse res = resBuilder.build();
