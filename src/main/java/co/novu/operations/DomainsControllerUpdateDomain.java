...
public class DomainsControllerUpdateDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<DomainsControllerUpdateDomainRequest, DomainsControllerUpdateDomainResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DomainsControllerUpdateDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerUpdateDomainRequest.class, new TypeReference<DomainsControllerUpdateDomainRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DomainsControllerUpdateDomainRequest request) {
        ...
        @Override
        public DomainsControllerUpdateDomainResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DomainsControllerUpdateDomainResponse.Builder resBuilder =
            ...
            DomainsControllerUpdateDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDomainResponseDto(Utils.unmarshal(response, new TypeReference<DomainResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DomainsControllerUpdateDomainRequest, co.novu.models.operations.async.DomainsControllerUpdateDomainResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DomainsControllerUpdateDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerUpdateDomainRequest.class, new TypeReference<DomainsControllerUpdateDomainRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DomainsControllerUpdateDomainRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.DomainsControllerUpdateDomainResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.DomainsControllerUpdateDomainResponse.Builder resBuilder =
                    co.novu.models.operations.async.DomainsControllerUpdateDomainResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.DomainsControllerUpdateDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DomainResponseDto>() {})
                            .thenApply(res::withDomainResponseDto);
                } else {
