...
public class LayoutsControllerDelete {
    ...
    public static class Sync extends Base
            implements RequestOperation<LayoutsControllerDeleteRequest, LayoutsControllerDeleteResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LayoutsControllerDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LayoutsControllerDeleteRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LayoutsControllerDeleteRequest request) {
        ...
        @Override
        public LayoutsControllerDeleteResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LayoutsControllerDeleteResponse.Builder resBuilder =
            ...
            LayoutsControllerDeleteResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LayoutsControllerDeleteRequest, co.novu.models.operations.async.LayoutsControllerDeleteResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LayoutsControllerDeleteRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LayoutsControllerDeleteRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LayoutsControllerDeleteRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.LayoutsControllerDeleteResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.LayoutsControllerDeleteResponse.Builder resBuilder =
                    co.novu.models.operations.async.LayoutsControllerDeleteResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.LayoutsControllerDeleteResponse res = resBuilder.build();
