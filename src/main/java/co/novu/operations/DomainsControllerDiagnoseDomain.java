...
public class DomainsControllerDiagnoseDomain {
    ...
    public static class Sync extends Base
            implements RequestOperation<DomainsControllerDiagnoseDomainRequest, DomainsControllerDiagnoseDomainResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DomainsControllerDiagnoseDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerDiagnoseDomainRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DomainsControllerDiagnoseDomainRequest request) {
        ...
        @Override
        public DomainsControllerDiagnoseDomainResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DomainsControllerDiagnoseDomainResponse.Builder resBuilder =
            ...
            DomainsControllerDiagnoseDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withDiagnoseDomainResponseDto(Utils.unmarshal(response, new TypeReference<DiagnoseDomainResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DomainsControllerDiagnoseDomainRequest, co.novu.models.operations.async.DomainsControllerDiagnoseDomainResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DomainsControllerDiagnoseDomainRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerDiagnoseDomainRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DomainsControllerDiagnoseDomainRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.DomainsControllerDiagnoseDomainResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.DomainsControllerDiagnoseDomainResponse.Builder resBuilder =
                    co.novu.models.operations.async.DomainsControllerDiagnoseDomainResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.DomainsControllerDiagnoseDomainResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<DiagnoseDomainResponseDto>() {})
                            .thenApply(res::withDiagnoseDomainResponseDto);
                } else {
