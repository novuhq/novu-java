...
import co.novu.models.components.ListDomainsResponseDto;
...
public class DomainsControllerListDomains {
    ...
    public static class Sync extends Base
            implements RequestOperation<DomainsControllerListDomainsRequest, DomainsControllerListDomainsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(DomainsControllerListDomainsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerListDomainsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DomainsControllerListDomainsRequest request) {
        ...
        @Override
        public DomainsControllerListDomainsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DomainsControllerListDomainsResponse.Builder resBuilder =
            ...
            DomainsControllerListDomainsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListDomainsResponseDto(Utils.unmarshal(response, new TypeReference<ListDomainsResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<DomainsControllerListDomainsRequest, co.novu.models.operations.async.DomainsControllerListDomainsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(DomainsControllerListDomainsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, DomainsControllerListDomainsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(DomainsControllerListDomainsRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.DomainsControllerListDomainsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.DomainsControllerListDomainsResponse.Builder resBuilder =
                    co.novu.models.operations.async.DomainsControllerListDomainsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.DomainsControllerListDomainsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListDomainsResponseDto>() {})
                            .thenApply(res::withListDomainsResponseDto);
                } else {
