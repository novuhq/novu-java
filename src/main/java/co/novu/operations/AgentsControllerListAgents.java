...
import co.novu.models.components.ListAgentsResponseDto;
...
public class AgentsControllerListAgents {
    ...
    public static class Sync extends Base
            implements RequestOperation<AgentsControllerListAgentsRequest, AgentsControllerListAgentsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(AgentsControllerListAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AgentsControllerListAgentsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(AgentsControllerListAgentsRequest request) {
        ...
        @Override
        public AgentsControllerListAgentsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AgentsControllerListAgentsResponse.Builder resBuilder =
            ...
            AgentsControllerListAgentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListAgentsResponseDto(Utils.unmarshal(response, new TypeReference<ListAgentsResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<AgentsControllerListAgentsRequest, co.novu.models.operations.async.AgentsControllerListAgentsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(AgentsControllerListAgentsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, AgentsControllerListAgentsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(AgentsControllerListAgentsRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.AgentsControllerListAgentsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.AgentsControllerListAgentsResponse.Builder resBuilder =
                    co.novu.models.operations.async.AgentsControllerListAgentsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.AgentsControllerListAgentsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListAgentsResponseDto>() {})
                            .thenApply(res::withListAgentsResponseDto);
                } else {
