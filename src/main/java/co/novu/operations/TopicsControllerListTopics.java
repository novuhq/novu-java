...
import co.novu.models.components.ListTopicsResponseDto;
...
public class TopicsControllerListTopics {
    ...
    public static class Sync extends Base
            implements RequestOperation<TopicsControllerListTopicsRequest, TopicsControllerListTopicsResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TopicsControllerListTopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TopicsControllerListTopicsRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TopicsControllerListTopicsRequest request) {
        ...
        @Override
        public TopicsControllerListTopicsResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TopicsControllerListTopicsResponse.Builder resBuilder =
            ...
            TopicsControllerListTopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListTopicsResponseDto(Utils.unmarshal(response, new TypeReference<ListTopicsResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TopicsControllerListTopicsRequest, co.novu.models.operations.async.TopicsControllerListTopicsResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TopicsControllerListTopicsRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TopicsControllerListTopicsRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TopicsControllerListTopicsRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.TopicsControllerListTopicsResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.TopicsControllerListTopicsResponse.Builder resBuilder =
                    co.novu.models.operations.async.TopicsControllerListTopicsResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.TopicsControllerListTopicsResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListTopicsResponseDto>() {})
                            .thenApply(res::withListTopicsResponseDto);
                } else {
