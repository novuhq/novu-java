...
public class SubscribersControllerDeleteNotification {
    ...
    static abstract class Base {
        ...
        BeforeRequestContextImpl createBeforeRequestContext() {
            return new BeforeRequestContextImpl(
                    ...
                    this.baseUrl,
                    "SubscribersController_deleteNotification",
    ...
    public static class Sync extends Base
            implements RequestOperation<SubscribersControllerDeleteNotificationRequest, SubscribersControllerDeleteNotificationResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(SubscribersControllerDeleteNotificationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SubscribersControllerDeleteNotificationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(SubscribersControllerDeleteNotificationRequest request) {
        ...
        @Override
        public SubscribersControllerDeleteNotificationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            SubscribersControllerDeleteNotificationResponse.Builder resBuilder =
            ...
            SubscribersControllerDeleteNotificationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<SubscribersControllerDeleteNotificationRequest, co.novu.models.operations.async.SubscribersControllerDeleteNotificationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(SubscribersControllerDeleteNotificationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, SubscribersControllerDeleteNotificationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(SubscribersControllerDeleteNotificationRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.SubscribersControllerDeleteNotificationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.SubscribersControllerDeleteNotificationResponse.Builder resBuilder =
                    co.novu.models.operations.async.SubscribersControllerDeleteNotificationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.SubscribersControllerDeleteNotificationResponse res = resBuilder.build();
