...
public class EventsControllerCancel {
    ...
    public static class Sync extends Base
            implements RequestOperation<EventsControllerCancelRequest, EventsControllerCancelResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(EventsControllerCancelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EventsControllerCancelRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(EventsControllerCancelRequest request) {
        ...
        @Override
        public EventsControllerCancelResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            EventsControllerCancelResponse.Builder resBuilder =
            ...
            EventsControllerCancelResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<EventsControllerCancelRequest, co.novu.models.operations.async.EventsControllerCancelResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(EventsControllerCancelRequest request) throws Exception {
            HttpRequest req = buildRequest(request, EventsControllerCancelRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(EventsControllerCancelRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.EventsControllerCancelResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.EventsControllerCancelResponse.Builder resBuilder =
                    co.novu.models.operations.async.EventsControllerCancelResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.EventsControllerCancelResponse res = resBuilder.build();
