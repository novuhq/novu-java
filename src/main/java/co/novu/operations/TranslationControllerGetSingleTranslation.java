...
public class TranslationControllerGetSingleTranslation {
    ...
    public static class Sync extends Base
            implements RequestOperation<TranslationControllerGetSingleTranslationRequest, TranslationControllerGetSingleTranslationResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(TranslationControllerGetSingleTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranslationControllerGetSingleTranslationRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(TranslationControllerGetSingleTranslationRequest request) {
        ...
        @Override
        public TranslationControllerGetSingleTranslationResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            TranslationControllerGetSingleTranslationResponse.Builder resBuilder =
            ...
            TranslationControllerGetSingleTranslationResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<TranslationControllerGetSingleTranslationRequest, co.novu.models.operations.async.TranslationControllerGetSingleTranslationResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(TranslationControllerGetSingleTranslationRequest request) throws Exception {
            HttpRequest req = buildRequest(request, TranslationControllerGetSingleTranslationRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(TranslationControllerGetSingleTranslationRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.TranslationControllerGetSingleTranslationResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.TranslationControllerGetSingleTranslationResponse.Builder resBuilder =
                    co.novu.models.operations.async.TranslationControllerGetSingleTranslationResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.TranslationControllerGetSingleTranslationResponse res = resBuilder.build();
