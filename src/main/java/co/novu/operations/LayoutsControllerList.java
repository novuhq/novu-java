...
import co.novu.models.components.ListLayoutResponseDto;
...
public class LayoutsControllerList {
    ...
    public static class Sync extends Base
            implements RequestOperation<LayoutsControllerListRequest, LayoutsControllerListResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nullable Options options,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(LayoutsControllerListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LayoutsControllerListRequest.class);
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LayoutsControllerListRequest request) {
        ...
        @Override
        public LayoutsControllerListResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LayoutsControllerListResponse.Builder resBuilder =
            ...
            LayoutsControllerListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withListLayoutResponseDto(Utils.unmarshal(response, new TypeReference<ListLayoutResponseDto>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<LayoutsControllerListRequest, co.novu.models.operations.async.LayoutsControllerListResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(LayoutsControllerListRequest request) throws Exception {
            HttpRequest req = buildRequest(request, LayoutsControllerListRequest.class);
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(LayoutsControllerListRequest request) {
        ...
        @Override
        public CompletableFuture<co.novu.models.operations.async.LayoutsControllerListResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            co.novu.models.operations.async.LayoutsControllerListResponse.Builder resBuilder =
                    co.novu.models.operations.async.LayoutsControllerListResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            co.novu.models.operations.async.LayoutsControllerListResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                res.withHeaders(response.headers().map());
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<ListLayoutResponseDto>() {})
                            .thenApply(res::withListLayoutResponseDto);
                } else {
