...
public class NovuAutoConfigProperties {
    ...
    public static class RetryConfig {
         ...
         */
        private co.novu.utils.RetryConfig.Strategy strategy;
         ...
         */
        public co.novu.utils.RetryConfig.Strategy getStrategy() {
            return strategy;
        }
         ...
         */
        public void setStrategy(co.novu.utils.RetryConfig.Strategy strategy) {
